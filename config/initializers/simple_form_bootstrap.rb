...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_form, class: 'mb-2' do |b|
    b.use :html5
    b.use :placeholder
  ...
  config.wrappers :vertical_boolean, tag: 'fieldset', class: 'mb-2' do |b|
    b.use :html5
    b.optional :readonly
  ...
  config.wrappers :vertical_collection, item_wrapper_class: 'form-check', item_label_class: 'form-check-label', tag: 'fieldset', class: 'mb-2' do |b|
    b.use :html5
    b.optional :readonly
  ...
  config.wrappers :vertical_collection_inline, item_wrapper_class: 'form-check form-check-inline', item_label_class: 'form-check-label', tag: 'fieldset', class: 'mb-2' do |b|
    b.use :html5
    b.optional :readonly
    b.wrapper :legend_tag, tag: 'legend', class: 'col-form-label pt-0' do |ba|
      ba.use :label_text
  ...
  # vertical file input
  config.wrappers :vertical_file, class: 'mb-2' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
  ...
  config.wrappers :vertical_select, class: 'mb-2' do |b|
    b.use :html5
    b.optional :readonly
    b.use :label, class: 'form-label'
  ...
  config.wrappers :vertical_multi_select, class: 'mb-2' do |b|
    b.use :html5
    b.optional :readonly
    b.use :label, class: 'form-label'
  ...
  config.wrappers :vertical_range, class: 'mb-2' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :readonly
    b.optional :step
  ...
  config.wrappers :horizontal_form, class: 'row mb-2' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
  ...
  config.wrappers :horizontal_boolean, class: 'row mb-2' do |b|
    b.use :html5
    b.optional :readonly
  ...
  config.wrappers :horizontal_collection, item_wrapper_class: 'form-check', item_label_class: 'form-check-label', class: 'row mb-2' do |b|
    b.use :html5
    b.optional :readonly
  ...
  config.wrappers :horizontal_collection_inline, item_wrapper_class: 'form-check form-check-inline', item_label_class: 'form-check-label', class: 'row mb-2' do |b|
    b.use :html5
    b.optional :readonly
    b.use :label, class: 'col-sm-3 col-form-label pt-0'
    b.wrapper :grid_wrapper, class: 'col-sm-9' do |ba|
  ...
  config.wrappers :horizontal_file, class: 'row mb-2' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
  ...
  config.wrappers :horizontal_select, class: 'row mb-2' do |b|
    b.use :html5
    b.optional :readonly
    b.use :label, class: 'col-sm-3 col-form-label'
    b.wrapper :grid_wrapper, class: 'col-sm-9' do |ba|
  ...
  config.wrappers :horizontal_multi_select, class: 'row mb-2' do |b|
    b.use :html5
    b.optional :readonly
    b.use :label, class: 'col-sm-3 col-form-label'
    b.wrapper :grid_wrapper, class: 'col-sm-9' do |ba|
  ...
  config.wrappers :horizontal_range, class: 'row mb-2' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :readonly
    b.optional :step
  ...
  config.wrappers :custom_boolean_switch, class: 'mb-2' do |b|
    b.use :html5
    b.optional :readonly
  ...
  config.wrappers :input_group, class: 'mb-2' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
  ...
  config.wrappers :floating_labels_form, class: 'form-floating mb-2' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
  ...
  # custom multi select
  config.wrappers :floating_labels_select, class: 'form-floating mb-2' do |b|
    b.use :html5
    b.optional :readonly
    b.use :input, class: 'form-select', error_class: 'is-invalid', valid_class: 'is-valid'
    b.use :label
